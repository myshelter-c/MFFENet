...
# file_dir = "/home/data/datasets"  # the directory that options.py resides in
...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--disparity_smoothness",
                                 ...
                                 default=1e-3)
        self.parser.add_argument("--disparity_edge",
                                 type=float,
                                 help="disparity edge weight",
                                 default=0.001)
        self.parser.add_argument("--disparity_relative",
                                 type=float,
                                 help="disparity relative weight",
                                 default=0)
