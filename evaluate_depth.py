...
def evaluate_for_mono(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        encoder = networks.HRTBackbone("hrt_tiny", pretrained=False)()
        encoder.num_ch_enc = [ 64, 18, 36, 72, 144 ]

        # encoder = networks.HRTBackbone("hrt_small", pretrained=False)()
        ...
        with torch.no_grad():
            ...
            for data in dataloader:
                ...
                output = depth_decoder(input_color, encoder(input_color))
...
if __name__ == "__main__":
    ...
    evaluate_for_mono(options.parse())
