...
# configs for HRT_TINY
HRT_TINY = CN()
HRT_TINY.DROP_PATH_RATE = 0.2

HRT_TINY.STAGE1 = CN()
HRT_TINY.STAGE1.NUM_MODULES = 1
HRT_TINY.STAGE1.NUM_BRANCHES = 1
HRT_TINY.STAGE1.NUM_BLOCKS = [2]
HRT_TINY.STAGE1.NUM_CHANNELS = [64]
HRT_TINY.STAGE1.NUM_HEADS = [2]
HRT_TINY.STAGE1.NUM_MLP_RATIOS = [4]
HRT_TINY.STAGE1.NUM_RESOLUTIONS = [[56, 56]]
HRT_TINY.STAGE1.BLOCK = "BOTTLENECK"

HRT_TINY.STAGE2 = CN()
HRT_TINY.STAGE2.NUM_MODULES = 1
HRT_TINY.STAGE2.NUM_BRANCHES = 2
HRT_TINY.STAGE2.NUM_BLOCKS = [2, 2]
HRT_TINY.STAGE2.NUM_CHANNELS = [18, 36]
HRT_TINY.STAGE2.NUM_HEADS = [1, 2]
HRT_TINY.STAGE2.NUM_MLP_RATIOS = [4, 4]
HRT_TINY.STAGE2.NUM_RESOLUTIONS = [[56, 56], [28, 28]]
HRT_TINY.STAGE2.NUM_WINDOW_SIZES = [7, 7]
HRT_TINY.STAGE2.ATTN_TYPES = [[['isa_local', 'isa_local'], ['isa_local', 'isa_local']]]
HRT_TINY.STAGE2.BLOCK = "TRANSFORMER_BLOCK"

HRT_TINY.STAGE3 = CN()
HRT_TINY.STAGE3.NUM_MODULES = 3
HRT_TINY.STAGE3.NUM_BRANCHES = 3
HRT_TINY.STAGE3.NUM_BLOCKS = [2, 2, 2]
HRT_TINY.STAGE3.NUM_CHANNELS = [18, 36, 72]
HRT_TINY.STAGE3.NUM_HEADS = [1, 2, 4]
HRT_TINY.STAGE3.NUM_MLP_RATIOS = [4, 4, 4]
HRT_TINY.STAGE3.NUM_RESOLUTIONS = [[56, 56], [28, 28], [14, 14]]
HRT_TINY.STAGE3.NUM_WINDOW_SIZES = [7, 7, 7]
HRT_TINY.STAGE3.ATTN_TYPES = [[['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local']],
                   [['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local']],
                   [['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local']]]
HRT_TINY.STAGE3.BLOCK = "TRANSFORMER_BLOCK"

HRT_TINY.STAGE4 = CN()
HRT_TINY.STAGE4.NUM_MODULES = 2
HRT_TINY.STAGE4.NUM_BRANCHES = 4
HRT_TINY.STAGE4.NUM_BLOCKS = [2, 2, 2, 2]
HRT_TINY.STAGE4.NUM_CHANNELS = [18, 36, 72, 144]
HRT_TINY.STAGE4.NUM_HEADS = [1, 2, 4, 8]
HRT_TINY.STAGE4.NUM_MLP_RATIOS = [4, 4, 4, 4]
HRT_TINY.STAGE4.NUM_RESOLUTIONS = [[56, 56], [28, 28], [14, 14], [7, 7]]
HRT_TINY.STAGE4.NUM_WINDOW_SIZES = [7, 7, 7, 7]
HRT_TINY.STAGE4.ATTN_TYPES = [[['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local']],
                   [['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local'], ['isa_local', 'isa_local']]]
HRT_TINY.STAGE4.BLOCK = "TRANSFORMER_BLOCK"
